...
const CommentsForm = ({ slug }) => {
  ...
  useEffect(() => {
    ...
    commentEl.current.value = window.localStorage.getItem('comments');
  }, []);
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg mb-8 p-8 pb-12'>
        ...
        <div className='mt-8'>
          <button type="button" className='transition duration-500 ease hover:bg-turquoise hover:text-gray-800 inline-blog rounded-lg bg-indigo-600 text-lg text-white px-8 py-3 cursor-pointer' onClick={handleCommentSubmission}>
              Post Comment
          </button>
